...
public class SQLWorkloadManager implements WorkloadManager {
	...
	/**
	 * The SQL holder to use.
	 */
	private final SQLHolder holder = new SQLHolder();

	/**
	 * Prepared statement to clear the workload. 
	 */
	private RepeatableStatement stmtClear;

	/**
	 * Prepared statement to clear the hosts.
	 */
	private RepeatableStatement stmtClear2;

	/**
	 * Prepared statement to add work. 
	 */
	...
	/**
	 * Prepared statement to get work. 
	 */
	...
	/**
	 * Prepared statement to empty the workload. 
	 */
	private RepeatableStatement stmtWorkloadEmpty;

	/**
	 * Prepared statement to get the status of a URL. 
	 */
	private RepeatableStatement stmtSetWorkloadStatus;

	/**
	 * Prepared statement to set the status of a URL. 
	 */	
	private RepeatableStatement stmtSetWorkloadStatus2;

	/**
	 * Prepared statement to get the depth of a URL. 
	 */
	private RepeatableStatement stmtGetDepth;

	/**
	 * Prepared statement to get the source of a URL. 
	 */
	private RepeatableStatement stmtGetSource;

	/**
	 * Prepared statement to resume. 
	 */
	...
	/**
	 * Prepared statement to get a URL's id.
	 */
	private RepeatableStatement stmtGetWorkloadID;

	/**
	 * Prepared statement to get a host id.
	 */
	private RepeatableStatement stmtGetHostID;

	/**
	 * Prepared statement to get the next host.
	 */
	private RepeatableStatement stmtGetNextHost;

	/**
	 * Prepared statement to set a host's status.
	 */
	private RepeatableStatement stmtSetHostStatus;

	/**
	 * Prepared statement to get a host.
	 */
