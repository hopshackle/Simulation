...
public class MCTreeProcessor<A extends Agent> {
    ...
    public void processTree(MonteCarloTree<A> t) {
        if (!(t instanceof TranspositionTableMCTree)) {
            throw new AssertionError("Only TranspositionTableMCTree currently supported in processTree()");
        }
