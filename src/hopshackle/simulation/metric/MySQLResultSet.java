        ...
        try {
            ...
            for (int metricLoop = 0; metricLoop < column2.length; metricLoop++) {
                ...
                for (int dsgLoop = 0; dsgLoop < dsGroup.length; dsgLoop++) {
                    ...
                    double count = metricStatSummary[dsgLoop].getN();
                    String temp2 = "INSERT INTO dsgSummaryAnalysis (datasetgroup, metric, mean, variance, stddev, stderr) VALUES" +
                            ...
                            ", " + metricStatSummary[dsgLoop].getStandardDeviation() / Math.sqrt(count - 1) + ");";
